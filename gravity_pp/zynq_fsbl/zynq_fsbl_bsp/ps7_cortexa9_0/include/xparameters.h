...
/* Definitions for driver GRAVITY */
#define XPAR_XGRAVITY_NUM_INSTANCES 1

/* Definitions for peripheral GRAVITY_0 */
#define XPAR_GRAVITY_0_DEVICE_ID 0
#define XPAR_GRAVITY_0_S_AXI_CRTLS_BASEADDR 0x40000000
#define XPAR_GRAVITY_0_S_AXI_CRTLS_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral GRAVITY_0 */
#define XPAR_XGRAVITY_0_DEVICE_ID XPAR_GRAVITY_0_DEVICE_ID
#define XPAR_XGRAVITY_0_S_AXI_CRTLS_BASEADDR 0x40000000
#define XPAR_XGRAVITY_0_S_AXI_CRTLS_HIGHADDR 0x4000FFFF
